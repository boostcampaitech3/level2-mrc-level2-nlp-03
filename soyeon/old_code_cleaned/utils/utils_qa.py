...
def postprocess_qa_predictions(
    ...
    """
    print('in post process main function')
    breakpoint()
    assert (
        len(predictions) == 2
    ...
    print('in post process main function2')
    breakpoint()
    ...
    print('in post process main function3')
    breakpoint()
    ...
    print('in post process main function4')
    breakpoint()
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        # 현재 example에 대한 모든 feature 생성합니다. -> feature_indices가 뭔지 파악 필요
        for feature_index in feature_indices:
            ...
            # 앞에 전처리에서 수정을 안한 것 같은데?
            token_is_max_context = features[feature_index].get(
                "token_is_max_context", None
            )


            # minimum null prediction을 업데이트 합니다. -> 0 일 수 있는 확률을 보려는 건가
            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    print('여기오는 친구는 누구냐')
                    # question_len = [5]
                    # passage_len = [10,20,15]  # Question CLS, SEP
                    #
                    # start_index= 13 # [cls] + question tokenzed + [sep] + passage1+[sep] + ..
                    # cur_score = doc_score[0]
                    breakpoint()
    ...
    print('in post process main function5')
    breakpoint()
